  ...
  return (
    <section className='flex h-full'>
      ...
      <div className='flex-grow p-8'>
        ...
        <p className='w-full max-w-2xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus voluptatum aperiam animi eum perspiciatis odit magnam esse deleniti debitis ducimus id fugiat saepe, quisquam quibusdam accusantium suscipit at! Corrupti, iure!</p>
      </div>
      {/* Tourist Attractions */}
      <div className='w-full max-w-[21rem] space-y-2 mr-12'>
        <h5>Cities Tourist Attractions</h5>
        <div className='flex flex-col gap-3 border rounded-2xl h-[95%] overflow-y-auto p-3 custom-scrollbar'>
          {/* Sample Card */}
